...
namespace nitroapi
{
    const std::unordered_map<StaticHookId, SearchConfig> EngineAddressProvider8684Linux::addresses_hook_id_
    {
        ...
        { StaticHookId::GL_UnloadTextures,          SearchConfig("GL_UnloadTextures", SearchType::ExportFunc) },
        { StaticHookId::Cbuf_InsertText,            SearchConfig("Cbuf_InsertText", SearchType::ExportFunc) },
        { StaticHookId::W_GetLumpName,              SearchConfig("W_GetLumpName", SearchType::ExportFunc) },
        { StaticHookId::Draw_Init,                  SearchConfig("Draw_Init", SearchType::ExportFunc) },
        { StaticHookId::Draw_Shutdown,              SearchConfig("Draw_Shutdown", SearchType::ExportFunc) },
        { StaticHookId::Draw_PicFromWad,            SearchConfig("Draw_PicFromWad", SearchType::ExportFunc) },
        { StaticHookId::Draw_CacheWadHandler,       SearchConfig("Draw_CacheWadHandler", SearchType::ExportFunc) },
        { StaticHookId::Draw_FreeWad,               SearchConfig("Draw_FreeWad", SearchType::ExportFunc) },
        { StaticHookId::Draw_CacheWadInit,          SearchConfig("Draw_CacheWadInit", SearchType::ExportFunc) },
        { StaticHookId::Draw_CacheWadInitFromFile,  SearchConfig("Draw_CacheWadInitFromFile", SearchType::ExportFunc) },
        { StaticHookId::Draw_MiptexTexture,         SearchConfig("Draw_MiptexTexture", SearchType::ExportFunc) },
        { StaticHookId::V_UpdatePalette,            SearchConfig("V_UpdatePalette", SearchType::ExportFunc) },
        { StaticHookId::V_CheckGamma,               SearchConfig("V_CheckGamma", SearchType::ExportFunc) },
        { StaticHookId::BuildGammaTable,            SearchConfig("BuildGammaTable", SearchType::ExportFunc) },
        { StaticHookId::GL_Config,                  SearchConfig("GL_Config", SearchType::ExportFunc) },
        { StaticHookId::Cvar_HookVariable,          SearchConfig("Cvar_HookVariable", SearchType::ExportFunc) },
        { StaticHookId::VGUI2_Draw_Init,            SearchConfig("VGUI2_Draw_Init", SearchType::ExportFunc) },
        { StaticHookId::Cmd_AddCommand,             SearchConfig("Cmd_AddCommand", SearchType::ExportFunc) },
        { StaticHookId::VGUI2_Draw_SetTextColor,    SearchConfig("VGUI2_Draw_SetTextColor", SearchType::ExportFunc) },
        ...
        { StaticHookId::NET_SendLoopPacket,         SearchConfig("NET_SendLoopPacket", SearchType::ExportFunc) },
        { StaticHookId::NET_SendLong,               SearchConfig("NET_SendLong", SearchType::ExportFunc) },
        { StaticHookId::NET_AdrToSockadr,           SearchConfig("NET_AdrToSockadr", SearchType::ExportFunc) },
    ...
    const std::unordered_map<std::string, SearchConfig> EngineAddressProvider8684Linux::addresses_str_
    {
        ...
        { "ip_sockets",                             SearchConfig("ip_sockets", SearchType::ExportFunc) },
        { "ipx_sockets",                            SearchConfig("ipx_sockets", SearchType::ExportFunc) },
    };
}