...
namespace nitroapi
{
        ...
        registry_(registry)
    {
        ...
        RegisterFuncCdecl<StaticHookId::GL_UnloadTextures>(&engine_data_->GL_UnloadTextures);
        RegisterFuncCdecl<StaticHookId::Cbuf_InsertText>(&engine_data_->Cbuf_InsertText);
        RegisterFuncCdecl<StaticHookId::W_GetLumpName>(&engine_data_->W_GetLumpName);
        RegisterFuncCdecl<StaticHookId::Draw_Init>(&engine_data_->Draw_Init);
        RegisterFuncCdecl<StaticHookId::Draw_Shutdown>(&engine_data_->Draw_Shutdown);
        RegisterFuncCdecl<StaticHookId::Draw_PicFromWad>(&engine_data_->Draw_PicFromWad);
        RegisterFuncCdecl<StaticHookId::Draw_CacheWadHandler>(&engine_data_->Draw_CacheWadHandler);
        RegisterFuncCdecl<StaticHookId::Draw_FreeWad>(&engine_data_->Draw_FreeWad);
        RegisterFuncCdecl<StaticHookId::Draw_CacheWadInit>(&engine_data_->Draw_CacheWadInit);
        RegisterFuncCdecl<StaticHookId::Draw_CacheWadInitFromFile>(&engine_data_->Draw_CacheWadInitFromFile);
        RegisterFuncCdecl<StaticHookId::Draw_MiptexTexture>(&engine_data_->Draw_MiptexTexture);
        RegisterFuncCdecl<StaticHookId::V_UpdatePalette>(&engine_data_->V_UpdatePalette);
        RegisterFuncCdecl<StaticHookId::V_CheckGamma>(&engine_data_->V_CheckGamma);
        RegisterFuncCdecl<StaticHookId::BuildGammaTable>(&engine_data_->BuildGammaTable);
        RegisterFuncCdecl<StaticHookId::GL_Config>(&engine_data_->GL_Config);
        RegisterFuncCdecl<StaticHookId::Cvar_HookVariable>(&engine_data_->Cvar_HookVariable);
        RegisterFuncCdecl<StaticHookId::VGUI2_Draw_Init>(&engine_data_->VGUI2_Draw_Init);
        RegisterFuncCdecl<StaticHookId::Cmd_AddCommand>(&engine_data_->Cmd_AddCommand);
