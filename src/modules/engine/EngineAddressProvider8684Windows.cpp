...
namespace nitroapi
{
    const std::unordered_map<StaticHookId, SearchConfig> EngineAddressProvider8684Windows::addresses_hook_id_
    {
        ...
        { StaticHookId::GL_UnloadTextures,          SearchConfig(0x3E920) },
        { StaticHookId::Cbuf_InsertText,            SearchConfig(0x27370) },
        { StaticHookId::W_GetLumpName,              SearchConfig(0xC58A0) },
        { StaticHookId::Draw_Init,                  SearchConfig(0x3C340) },
        { StaticHookId::Draw_Shutdown,              SearchConfig(0x2F2B0) },
        { StaticHookId::Draw_PicFromWad,            SearchConfig(0x3C150) },
        { StaticHookId::Draw_CacheWadHandler,       SearchConfig(0x2F660) },
        { StaticHookId::Draw_FreeWad,               SearchConfig(0x2F680) },
        { StaticHookId::Draw_CacheWadInit,          SearchConfig(0x2F440) },
        { StaticHookId::Draw_CacheWadInitFromFile,  SearchConfig(0x2F360) },
        { StaticHookId::Draw_MiptexTexture,         SearchConfig(0x3F210) },
        { StaticHookId::V_UpdatePalette,            SearchConfig(0xC1A70) },
        { StaticHookId::V_CheckGamma,               SearchConfig(0xC19B0) },
        { StaticHookId::BuildGammaTable,            SearchConfig(0xC1770) },
        { StaticHookId::GL_Config,                  SearchConfig(0x4CBC0) },
        { StaticHookId::Cvar_HookVariable,          SearchConfig(0x2F0F0) },
        { StaticHookId::VGUI2_Draw_Init,            SearchConfig(0x69E0) },
        { StaticHookId::Cmd_AddCommand,             SearchConfig(0x281A0) },
